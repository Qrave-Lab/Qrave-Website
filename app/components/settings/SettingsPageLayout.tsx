...
type Props = {
  ...
  /** Optional back navigation target. Defaults to /staff/settings */
  backHref?: string;
    ...
    <div className="flex h-screen w-full bg-[#f8fafc] text-slate-900 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between shrink-0 z-10">
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              {description && (
                <p className="text-sm text-slate-500 mt-0.5 leading-snug truncate">
                  {description}
                </p>
              )}
            </div>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className={`mx-auto ${maxWidth} space-y-6 pb-10`}>
            {children}
          </div>
        </main>
      </div>
