    ...
    return (
        <div className="space-y-6 p-6">
            <div className="flex items-center gap-2">
                <Palette className="h-4 w-4 text-[#fe5c13]" />
            ...
            <div>
                    ...
                    {presetColors.map((c) => (
                        <button
                            ...
                            className={`h-8 rounded-lg border transition-transform hover:scale-110 shadow-sm ${qrConfig.fgColor === c
                                ? 'border-[#fe5c13] ring-2 ring-[#fe5c13]/20'
                                : 'border-gray-100'
                                }`}
                ...
                <div className="mt-2 flex items-center gap-2">
                    ...
                    <input
                        value={qrConfig.fgColor}
                        onChange={(e) => update({ fgColor: e.target.value })}
                        className="flex-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-700 focus:outline-none focus:border-[#fe5c13]"
                    />
                </div>
            </div>
                    ...
                    {frameStyles.map((f) => (
                        <button
                            ...
                            className={`rounded-xl border px-3 py-3 text-center transition-all ${qrConfig.frameStyle === f.value
                                ? 'border-[#fe5c13] bg-[#fe5c13]/10 text-[#fe5c13] shadow-sm'
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-700 placeholder:text-gray-300 focus:outline-none focus:border-[#fe5c13]"
                    placeholder="SCAN ME"
                />
            </div>
            ...
            <div className="space-y-3 rounded-xl border border-gray-200 bg-gray-50/60 p-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-700 placeholder:text-gray-300 focus:outline-none focus:border-[#fe5c13]"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={2}
                        className="w-full resize-none rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-700 placeholder:text-gray-300 focus:outline-none focus:border-[#fe5c13]"
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full accent-[#fe5c13]"
                />
            </div>
        </div>
    );
