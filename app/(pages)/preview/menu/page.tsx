...
const SAMPLE_MENU = [
  ...
  },
  {
    id: "p2",
    name: "Fresh Avocado",
    description: "Premium sliced creamy avocado for an immersive view.",
    categoryName: "Starters",
    parentCategoryName: "Food",
    price: 150,
    imageUrl: "https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?auto=format&fit=crop&w=800&q=80",
    arModelGlb: "https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/Avocado/glTF-Binary/Avocado.glb",
    isVeg: true,
    rating: 4.9,
