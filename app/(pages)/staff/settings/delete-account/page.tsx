      ...
      <div className="flex h-screen w-full bg-[#f8fafc] text-slate-900 overflow-hidden font-sans">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="max-w-md w-full rounded-2xl border border-slate-200 bg-white p-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-600">Only owner can delete the account.</p>
            <Link
              href="/staff/settings"
              className="mt-6 inline-flex items-center gap-2 rounded-lg border border-slate-200 px-4 py-2 text-xs font-bold text-slate-700"
            >
          ...
          <section className="bg-white rounded-2xl border border-rose-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-rose-100 bg-rose-50/50">
              ...
              <p className="text-[11px] text-rose-600 mt-1">
                This action is permanent. It will remove your restaurant, staff, menu, tables and history.
              </p>
            </div>

            <div className="p-6 space-y-4">
              <p className="text-xs text-slate-600">
                OTP will be sent to <span className="font-bold">{email || "your email"}</span>
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-slate-200 text-xs font-bold text-slate-700 disabled:opacity-60"
                >
                  {requestingOtp
                    ? "Sending..."
                    : cooldown > 0
                ...
                <button
                  ...
                  disabled={deleting}
                  className="px-4 py-2 rounded-lg bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold disabled:opacity-60"
                >
