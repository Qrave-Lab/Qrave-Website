    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 font-sans overflow-hidden">
      ...
      <div className="no-print w-96 bg-white border-r border-gray-200 flex flex-col z-20 shadow-xl">
        ...
        <div className="h-16 border-b border-gray-100 flex items-center px-6 justify-between shrink-0">
          <button onClick={() => router.push("/staff/settings/devices")} className="text-gray-500 hover:text-gray-900 transition-colors">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {tables.map((t) => (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center p-2 rounded-lg border text-sm font-bold transition-all ${selectedTable.id === t.id
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {templates.map(t => (
                      <button
                        ...
                        className={`px-2 py-2 text-xs font-medium rounded-md border transition-all ${template === t.id ? "border-purple-600 bg-purple-50 text-purple-700" : "border-gray-200 text-gray-600 hover:bg-gray-50"
                          }`}
                      >
                        {t.name}
                      </button>
                  ...
                  <div className="flex rounded-md shadow-sm border border-gray-200 overflow-hidden">
                    {fonts.map(f => (
                      <button
                        ...
                        className={`flex-1 py-2 text-xs font-medium transition-colors ${f.class} ${activeFont === f.id ? "bg-gray-900 text-white" : "bg-white text-gray-600 hover:bg-gray-50"
                          }`}
                      >
                        Aa
                      </button>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full w-full items-center p-12">
                ...
                {/* Main QR Card */}
                <div
                  className={`p-6 rounded-3xl shadow-xl mb-8 transition-all duration-300 ${template === 'dark' ? 'bg-white/10 backdrop-blur-md border border-white/20' : 'bg-white'
                    }`}
                  style={{
                ...
                <div className="mt-auto w-full space-y-6">
                  ...
                  {(wifiSsid) && (
                    <div className={`mx-auto inline-flex items-center gap-3 px-4 py-2 rounded-lg border ${template === 'dark' ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'
                      }`}>
