...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex min-h-screen w-full font-sans text-[#1F2127] overflow-hidden bg-white selection:bg-amber-500/30">
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <header className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              <div className={`rounded-xl border px-3 py-2 text-[10px] font-black uppercase tracking-widest ${step === "request" ? "bg-amber-50 border-amber-200 text-amber-800" : "bg-slate-50 border-slate-200 text-slate-400"}`}>
                1. Send OTP
              </div>
              <div className={`rounded-xl border px-3 py-2 text-[10px] font-black uppercase tracking-widest ${step === "reset" ? "bg-amber-50 border-amber-200 text-amber-800" : "bg-slate-50 border-slate-200 text-slate-400"}`}>
                2. Set Password
              </div>
            </div>
          </header>
            ...
            {step === "request" ? (
              ...
              >
                ...
                <button
                  type="submit" 
                  disabled={isLoading}
                  className="w-full py-5 rounded-2xl bg-amber-500 font-bold text-sm uppercase tracking-widest shadow-[0_4px_20px_rgba(232,144,10,0.3)] hover:shadow-[0_8px_25px_rgba(232,144,10,0.45)] hover:bg-amber-600 transition-all active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-70 border border-amber-500/10"
                >
              ...
              >
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <ShieldCheck className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-amber-600 transition-colors" />
                      <input 
                        type="text" 
                        required
                        value={code}
                        ...
                        className="w-full pl-14 pr-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 outline-none transition-all font-bold placeholder:text-slate-300 tracking-[0.2em]"
                        maxLength={4}
                      />
                    </div>
                  </div>
                ...
                <div className="pt-2 text-center">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 mx-auto text-[11px] font-black uppercase tracking-widest transition-colors disabled:text-slate-300 text-amber-600 hover:text-amber-700"
                  >
      ...
      <div className="hidden lg:flex flex-1 relative bg-[#FAFAFA] items-center justify-center border-l border-slate-100 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <svg viewBox="0 0 1440 800" preserveAspectRatio="none" className="absolute bottom-0 left-0 w-full h-[60%] pointer-events-none">
            <path d="M0,800 L0,600 C 400,600 800,100 1440,100 L1440,800 Z" fill="var(--color-amber-500)" fillOpacity="0.10" />
            <path d="M0,800 L0,700 C 400,700 800,400 1440,400 L1440,800 Z" fill="var(--color-amber-500)" fillOpacity="0.20" />
            <path d="M0,800 L0,760 C 400,780 1000,740 1440,760 L1440,800 Z" fill="var(--color-amber-500)" fillOpacity="0.05" />
          </svg>
        </div>
            ...
            <div className="space-y-6">
              <h1 className="text-6xl xl:text-7xl font-bold leading-[1.05] tracking-tight">
                ...
                <span className="relative inline-block text-amber-500">
                  account.
                  <svg className="absolute -bottom-3 left-0 w-full h-4 text-amber-500" viewBox="0 0 100 15" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
